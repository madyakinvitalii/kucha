...
let virtual-env = "\\Disk-O\www_modejiuer_mail_ru\pythonProject\DZ15.2\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "\\Disk-O\www_modejiuer_mail_ru\pythonProject\DZ15.2\venv\Scripts\deactivate.nu"
